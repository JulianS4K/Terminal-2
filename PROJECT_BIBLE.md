...
> **Doc version:** v1.2.0 · baseline 2026-05-28 (A1); v1.2.0 2026-05-30 (A1) — §5 rule 5 + §3 landmine: orders/sales obey the native-ID rule, map via the AQ mapper. Section-level version + bot-ref convention → [`README.md`](README.md) *Doc-writing rules*.
