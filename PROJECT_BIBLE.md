...
LANE MAP (codes name cells in a layer × product grid — flat, no ranks; §2.1 sets permission, §2.3 the grid):
  ...
  PRODUCTS (each a distinct surface that sits on the substrate; some share a deploy service):
    D0 terminal + orders-dashboard   D1 store   D3 broadway   D4 Bridge/Exos (full app)   D5 fantasy (sports)
...
**The codes are not a flat peer list.** They name cells in a **layer × product** grid: a two-area **platform substrate** (the shared foundation) and the **products** that sit on it — **seven lanes** (substrate A1·B1 + products D0·D1·D3·D4·D5). Two codes were retired as first-class lanes on 2026-07-02 (see the note below the tables).
