...
## 0. The AQ mapper is THE hub — read before any cross-source SQL *(v1.1 · A1 · 2026-06-19)*
...
| `sg_match_map_tick()` | SG-mapped event → other-platform `sh`/`vivid` ids via TD `/match` (**SeatGeek-URL-anchored** — see §3) | `*/10` cron, budget-gated 50% |
...
## 3. Column-name landmines (catch SQL bugs before you author) *(v1.5 · A1 · 2026-06-19)*
