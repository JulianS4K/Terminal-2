...
## 8. Workflow recipes *(v1.2 · C1 · 2026-06-09)*

### "I want to understand the codebase fast (code knowledge graph)" *(v1.1 · C1 · 2026-06-09)*
...
- **To regenerate / re-chart:** `/understand` rebuilds the graph (nodes = files/functions/classes/SQL-migration tables/docs/configs/CI-pipelines; edges = imports/contains/exports/tested_by/depends_on; grouped into architectural layers + a guided tour); `/understand-dashboard` opens the full plugin dashboard on it.
...
- **Snapshot (2026-06-09):** ≈1,855 nodes / 2,067 edges across **17 layers** (Database Migrations, Backend API & Source Clients, D4 Bridge, D0 Terminal, D1 Storefront, Edge Functions, CI/CD, Docs & Governance, Trip Planner, …). Fastest way to see "what talks to what" before touching a lane.
