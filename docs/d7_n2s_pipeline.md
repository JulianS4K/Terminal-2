...
| cron 598 | every minute | `n2s_map_events(true); n2s_gt_map_by_name(); n2s_pull_all_sources();` — map, then the D7 GoTickets name+venue second pass (20260911020000), then poll the newly-mapped |
