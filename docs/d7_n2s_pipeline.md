...
disagreements. **Vivid Seats, TickPick and SeatGeek failed orders are in no book we hold**
(0 of 117 / 107 / 16 in `vivid_orders`, `tickpick_orders`, `seatgeek_orders`) — the seller
books carry only orders that processed — so they stay on rules 0–5. Do not add a "rule 0d"
for them without re-measuring; it would be dead code.
