...
| [`docs/d_tier_goals.md`](d_tier_goals.md) | North-star/destination per D-lane (D0–D4, E1) + the endgame ("open-distribution Ticketmaster") — companion to the bible's "what is" and the plan's "route". Operator-ratified 2026-05-24 | When a lane's vision changes |
