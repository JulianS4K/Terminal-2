...
## 5.5 Code lane-assignment map (full-tree audit) *(v1.2 · operator · 2026-06-19)*
...
| `routers/*` (app.py decomposition, BR-CODE-1) | **A1** (package) · per-surface blocks lane-owned | extracted `APIRouter` modules `include_router`'d back into `app.py`; one-directional import (`app.py`→`routers`); shared API surface (§5.5b) |
