-- ROLLBACK STEP 3b/3 — restore public.compute_event_listing_snapshot(text)
-- verbatim to its latest origin/main (e43d549) definition, from
-- supabase/migrations/20260606160000_fix_td_tp_median_price_with_fees.sql.
--
-- The branch overwrote it in 20260901004828 to add a TD freshness bound.
