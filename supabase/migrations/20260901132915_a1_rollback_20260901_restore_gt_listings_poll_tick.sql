-- ROLLBACK STEP 3b/1 — restore public.gt_listings_poll_tick(integer) verbatim to
-- its latest origin/main (e43d549) definition, from
-- supabase/migrations/20260811274000_gt_poll_all_us_tiered_cadence.sql.
--
-- The branch overwrote it three times (20260831190000 scope-to-EVO-set,
-- 20260831210000 antiphase dual band, 20260831211000 rate-neutral fix).
