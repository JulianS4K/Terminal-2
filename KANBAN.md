...
- **Stage 3 — organizer side:** D4-OPS-24 analytics + CSV export (scan-in / no-show / promoter) · D4-OPS-22 self-serve RSVP release · group / comp allocations · D4-OPS-27 recurring + timed-entry series · scanner scan-reject audit UI.
