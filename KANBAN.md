...
2. **D4-OPS-10** offline multi-lane double-admit policy (**M**, design + impl) — depends on the D4-OPS-1 decision (online-only door vs shared-lock channel). **← next decision needed.**
