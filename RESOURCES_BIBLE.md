...
> **Doc version:** v2.22.0 (2026-07-03; §6 edge-fn catalog 31→33 — added `broadway-cast-collect` (D3 Broadway cast overlay) + `notebook-llm` (open-notebook Claude proxy), both shipped but uncatalogued). Full prior doc-version history → [`docs/archive/2026-07-02-doc-version-history.md`](docs/archive/2026-07-02-doc-version-history.md).
