...
> **Doc version:** v1.2.0 · baseline 2026-05-28 (A1); v1.1.0 2026-05-31 (A1) — §14 appended 6 collector-cadence + retention migs (`20260531140000`–`200000`); v1.2.0 2026-06-03 (A1) — §14 appended SG owned/non poller split (`20260603180000`) + raw-listings retention halve 30d→15d (`20260603190000`); v1.3.0 2026-06-03 (A1) — §14 appended 3 data-health audit fixes (`20260603200000`–`220000`). Section-level version + bot-ref convention → [`README.md`](README.md) *Doc-writing rules*.
